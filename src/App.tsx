  ...
  return (
    <>
      <div className="min-h-screen bg-slate-950 text-white relative overflow-hidden">
        {/* Fond amélioré avec plusieurs couches */}
        <div className="fixed inset-0 bg-gradient-to-br from-indigo-900 via-slate-800 to-indigo-900"></div>
        
        {/* Effets de particules/grid animé */}
        {/* Grille très visible */}
  <div className="fixed inset-0 opacity-10">
    <div className="absolute inset-0 bg-[linear-gradient(#0ea5e9_1px,transparent_1px),linear-gradient(90deg,#0ea5e9_1px,transparent_1px)] bg-[size:80px_80px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,black_40%,transparent_100%)]"></div>
  </div>

  {/* Orbes très colorés et visibles */}
  <div className="fixed inset-0 overflow-hidden pointer-events-none">
    <div className="absolute -top-32 -left-32 w-[500px] h-[500px] bg-cyan-500/30 rounded-full blur-3xl animate-pulse"></div>
    <div className="absolute -bottom-32 -right-32 w-[500px] h-[500px] bg-blue-500/30 rounded-full blur-3xl animate-pulse delay-2000"></div>
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-cyan-800/25 rounded-full blur-3xl animate-pulse delay-1000"></div>
  </div>

  {/* Brillance très visible */}
  <div className="fixed inset-0 bg-gradient-to-b from-cyan-500/20 via-transparent to-transparent pointer-events-none"></div>
        {/* Contenu principal */}
        <div className="relative z-10">
          {/* navbar */}
          <nav className="fixed top-0 w-full bg-slate-900/20 backdrop-blur-sm z-50 border-b border-slate-700/50 flex justify-between items-center p-4">
            <div className="flex gap-2 text-xl font-bold">
              <Code2 className="text-cyan-300" size={30} />
              <h1 className="text-cyan-300">Antonio</h1>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                  <a href="#contact" className="bg-gradient-to-r from-cyan-400 to-cyan-600 hover:from-cyan-600 hover:to-blue-700 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-cyan-500/25">
                    Me contacter
                  </a>
          ...
          {/* Sections restantes avec fonds améliorés */}
            ...
            <div className="relative z-10 max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4 bg-slate-800/30 backdrop-blur-sm p-6 rounded-xl border border-slate-600/50 hover:bg-slate-800/50 transition-all duration-300">
          ...
          <section id="skills" className="py-20 px-6 relative">
            ...
            <div className="relative z-10 max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-slate-700/20 backdrop-blur p-8 rounded-xl border border-slate-700/50 hover:bg-slate-800/50 transition-all duration-300 transform hover:-translate-y-2">
